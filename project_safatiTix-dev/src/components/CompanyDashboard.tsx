    ...
    <div style={styles.container}>
      ...
      <aside style={styles.sidebar}>
        <div style={styles.logo}>
          ...
          <span style={styles.logoText}>Zarss</span>
        </div>

        <div style={styles.profile}>
          <div style={styles.profileAvatar} />
          <p style={styles.profileLabel}>Welcome Back,</p>
          <p style={styles.profileName}>{user?.name || 'Mark Johnson'}</p>
        </div>
        ...
        <nav style={styles.nav}>
          ...
          <button
            ...
            onClick={() => navigate('/dashboard/company/schedules')}
            onMouseEnter={(e) => e.currentTarget.style.background = '#35374A'}
          ...
          <button
            style={styles.navItem}
            onClick={() => navigate('/dashboard/company/tickets')}
            onMouseEnter={(e) => e.currentTarget.style.background = '#35374A'}
            onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}
          >
            <span style={styles.navIcon}>🎫</span>
          ...
          <button
            style={styles.navItem}
            onClick={() => navigate('/dashboard/company/buses')}
            onMouseEnter={(e) => e.currentTarget.style.background = '#35374A'}
            onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}
          >
            <span style={styles.navIcon}>🚌</span>
          ...
          <button
            style={styles.navItem}
            onClick={() => navigate('/dashboard/company/drivers')}
            onMouseEnter={(e) => e.currentTarget.style.background = '#35374A'}
            onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}
          >
            <span style={styles.navIcon}>👤</span>
          ...
          <button
            style={styles.navItem}
            onClick={() => navigate('/dashboard/company/tracking')}
            onMouseEnter={(e) => e.currentTarget.style.background = '#35374A'}
            onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}
          >
            <span style={styles.navIcon}>📍</span>
          ...
          <button
            style={styles.navItem}
            onClick={() => navigate('/dashboard/company/revenue')}
            onMouseEnter={(e) => e.currentTarget.style.background = '#35374A'}
            onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}
          >
            <span style={styles.navIcon}>💰</span>
        ...
        <header style={styles.header}>
          <div style={styles.headerTop}>
            <div>
              ...
              <p style={styles.headerSubtitle}>Payments Updates</p>
            </div>
